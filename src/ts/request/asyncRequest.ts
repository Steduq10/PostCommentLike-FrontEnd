...
export async function createPost(post:PostI){
  ...
  export async function createComment(comment:commentsI){
  ...
  export async function deleteComment(comment:commentsI){
  ...
  export async function editComment(comment:commentsI){
